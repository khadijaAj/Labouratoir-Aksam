...
@section('title', 'Modifier fournisseur - Aksam Labs')
...
<form action="{{ route('fournisseurs.update',$fournisseur->id) }}" method="POST"> 
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" name="name" value="{{ $fournisseur->name }}" placeholder="Enter le nom du fournisseur">
        </div>
        <div class="form-group col-md-6">
            <label for="ref_fournisseur">Référence</label>
            <input type="text" class="form-control" name="Reference" value="{{ $fournisseur->Reference }}" placeholder="Entrer la référence">
        </div>
    ...
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" name="tele" value="{{ $fournisseur->tele }}"
                placeholder="Entrer le numéro du téléphone">
        </div>
        <div class="form-group col-md-6">
            <label for="adresse_fournisseur">Adresse</label>
            <input type="text" class="form-control" name="adresse" value="{{ $fournisseur->adresse }}" placeholder="Enter l'adresse">
        </div>
