...
<div class="form-row align-items-right" style="float:left;">
    ...
    <div class="col-auto">
        ...
        <button type="submit" style="border-radius: 40px ;background-color:#3A9341;" class="btn mb-2"><a
                style="color: #ffffff; text-decoration: none; " href="/add_nutriment">Ajouter un nutriment</a></button>
    </div>
    <div class="col-auto">
        <br>
        <button type="submit" style="border-radius: 40px ;background-color:#3A9341;" class="btn mb-2"><a
...
<div class="table-responsive">
    ...
    <table id="nutriments" class="table">
...
la la-trash-o"></i>&nbsp;&nbsp;<i style="color:#000;" class="la la-eye"></center></td>	
