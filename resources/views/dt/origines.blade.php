...
<div>
    ...
    <div class="form-row col-sm-6  align-items-right" style="float:right;">
        ...
        <div class="input-group mb-2">
            ...
            <input type="text" id="myInput" onkeyup="myFunction()" class="form-control" style="border: 1px solid #ced4da" id="inlineFormInputGroup"
...
<form style="border: 2px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="{{ URL::to('importExcelOrigine') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
		{{ csrf_field() }}
