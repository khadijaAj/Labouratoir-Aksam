...
<div>
    <div class="form-row col-sm-6  align-items-right" style="float:right;">
        ...
        <div class="input-group mb-2">
            ...
            <input type="text" class="form-control" id="myInput" onkeyup="myFunction()" style="border: 1px solid #ced4da" id="search_categorie"
...
<div class="form-row col-sm-6  align-items-right" style="float:left;">
    ...
    <div class="col-auto">
        ...
        <button type="submit" style="border-radius: 40px ;background-color:#3A9341;" class="btn mb-2"><a
                style="color: #ffffff; text-decoration: none; " href="{{ route('categories.create') }}">Ajouter une catégorie</a></button>
    </div>
    <div class="col-auto">
        <br>
...
<form style="border: 2px solid #a1a1a1;margin-top: 15px;padding: 10px;" action="{{ URL::to('importExcelCategorie') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
		{{ csrf_field() }}
