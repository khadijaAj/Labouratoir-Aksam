...
@section('title', 'Modifier Categorie - Aksam Labs')
...
<form action="{{ route('categories.update',$categorie->id) }}" method="POST"> 
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" value="{{ $categorie->name }}" placeholder="Enter le nom d'origine">
    </div>

    <div class="form-group">
        <label for="ref_origine">Référence</label>
        <input type="text" class="form-control" name="Reference" value="{{ $categorie->Reference }}"  placeholder="Entrer la référence">
    </div>
