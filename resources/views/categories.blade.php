...
<div>
    <div class="form-row col-sm-6  align-items-right" style="float:right;">
        ...
        <div class="input-group mb-2">
            ...
            <input type="text" class="form-control" style="border: 1px solid #ced4da" id="search_categorie"
...
<div class="form-row col-sm-6  align-items-right" style="float:left;">
    ...
    <div class="col-auto">
        ...
        <button type="submit" style="border-radius: 40px ;background-color:#3A9341;" class="btn mb-2"><a
                style="color: #ffffff; text-decoration: none; " href="/add_categorie">Ajouter une catégorie</a></button>
    </div>
    <div class="col-auto">
        <br>
        <button type="submit" style="border-radius: 40px ;background-color:#3A9341;" class="btn mb-2"><a
