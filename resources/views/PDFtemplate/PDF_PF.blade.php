...
<body>
  ...
  margin-top:10px; margin-left:200px;background-color:#B5E0FA;border: 1px solid black;"> <br><strong>
                        <p style="font-size: 20px;"><b> <br>Rapport d'analyse PF</p>
                    </strong></b></div>
            </center>
  ...
  " class="table table-bordered ">
            ...
            @foreach($pfrapports as $pfrapport)
                <tr style="border:none;">
                    ...
                    @endif
                    @endforeach
                    <td style="border:none;border-right: 1px solid #F2F4F3;"><center>{{ $pfrapport->ACE}}
</center></td>
                    <td style="border:none;border-right: 1px solid #F2F4F3;"><center>{{ $pfrapport->MSR}}
</center></td>
