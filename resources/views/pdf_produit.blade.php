...
<body>
        ...
        <div >
            ...
            <table id="customers" style="border-collapse: collapse;width: 100%;">
                <tr>
                    ...
                    <th style="padding-top: 12px; padding-bottom: 12px; text-align: left; background-color: #4CAF50; color: white;  border: 1px solid #ddd;padding: 8px;">Categorie</th>

                </tr>
				@foreach($elements as $data)
                <tr><?php $CategorieName = App\Categorie::find($data->categorie_id); ?>
  ...
  padding: 8px;">{{ $data->Reference }}</td>
   <td style="  border: 1px solid #ddd;
  padding: 8px;">{{ $CategorieName->name }}</td>
                </tr>
                @endforeach
            </table>
        </div>
