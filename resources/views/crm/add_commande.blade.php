...
<div class="form-row">
  ...
  <div class="form-group col-md-6">
        ...
        <input name="reference"  class="form-control datepicker" type="text" value="{{old('reference')}}">
     </div>
  </div>
  <div class="form-row">
     <div class="form-group col-md-6">
   ...
   <div class="form-group col-md-6">
        ...
        <input name="conditionReglement" class="form-control datepicker" type="number"  value="{{old('conditionReglement')}}"  min="15" max="60">
      </div>
</div>
<div class="card">
