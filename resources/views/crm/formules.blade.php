...
<div class="form-row align-items-right" style="float:left;">
    ...
    <div class="col-auto">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <a class="dropdown-item" href="{{ route('exportfr') }}">Excel</a>
...
<div class="table-responsive">
    <table class="table "  id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
               <td>
                    <center> <input type="checkbox" class="id" name="id" value="{{ $formule->id}}">
                    </center>
                </td>
                <td>
...
$(document).ready(function(even) {
    $("#export-pdf").click(function() {
        ...
        if (checkvalue.length > 0) {
            window.open("{{URL::to('/')}}/PDF_Formule?ids=" + checkvalue, "_blank");
        } else {
            window.open("{{URL::to('/')}}/PDF_Formule");
