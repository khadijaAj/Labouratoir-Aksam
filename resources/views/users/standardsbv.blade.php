...
@section('title', 'standrdsbovin - Aksam Labs')
...
<div class="form-row col-sm-6  align-items-right" style="float:left;">
    ...
    <div class="col-auto">
        ...
        <button type="submit" style="border-radius: 40px ;background-color:#3A9341;" class="btn mb-2"><a
                style="color: #ffffff; text-decoration: none; " href="{{ route('standardsbv.create') }}">Ajouter un critère</a></button>
    </div>
</div>
</div>
    ...
    <table id="myTable"  class="table table-bordered" >
        ...
        @if ($standardsbv->count() == 0)
            ...
            <tr>
                ...
                <td>
                    <center>{{$bv->valeur}}</center>
                </td>
                <td>
                <form action="{{route('standardsbv.destroy',$bv->id)}}" method="POST">
